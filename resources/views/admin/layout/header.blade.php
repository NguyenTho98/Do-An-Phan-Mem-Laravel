<header class="header">
    <div class="logo-container">
        <a href="admin" class="logo">
            <img src="{{asset('public/img/logo.png')}}" width="75" height="35" alt="Porto Admin" />
        </a>
        ...
        <div id="userbox" class="userbox">
            <a href="#" data-toggle="dropdown">
                <figure class="profile-picture">
                    <img src="{{asset('public/img/%21logged-user.jpg')}}" alt="Joseph Doe" class="rounded-circle" data-lock-picture="img/%21logged-user.jpg" />
                </figure>
                <div class="profile-info" data-lock-name="John Doe" data-lock-email="johndoe@okler.com">
                    @if (Auth::guard('admin')->user())
                        ...
                        Auth::guard('admin')->user()->role ?  (Auth::guard('admin')->user()->name == 'admin' ? 'Admin' : Auth::guard('admin')->user()->role->title ) : 'Nhân viên' }}</span>
                    @endif
                </div>
            ...
            <div class="dropdown-menu">
                <ul class="list-unstyled mb-2">
                    <li class="divider"></li>
                    <li>
                        <a role="menuitem" tabindex="-1" href="admin"><i class="fas fa-user"></i> My Profile</a>
                    </li>
                    <li>
                        <a role="menuitem" tabindex="-1" href="#" data-lock-screen="true"><i class="fas fa-lock"></i> Lock Screen</a>
                    </li>
                    <li>
                        <a role="menuitem" tabindex="-1" href="admin/users/logout"><i class="fas fa-power-off"></i> Logout</a>
                    </li>
                </ul>
            </div>
        </div>
