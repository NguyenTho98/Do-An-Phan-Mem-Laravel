                ...
                <tbody>
                    @foreach ($customers as $customer)
                        <tr class="post{{$customer->id}}">
                            ...
                            <td class="actions">
                                <a href="{{ url('admin/customers/detail')."/".$customer->id }}" class="detail-row"><i class="fas fa-eye"></i></a>
            ...
            <div class="card-body">
                <div class="modal-wrapper">
                    ...
                    <div class="modal-text">
                        <p class="mb-0">Xác nhận xóa lịch sử giao dịch và các hoạt động liên quan đến khách hàng này. Bạn có chắc chắn muốn xóa?</p>
                    </div>
                </div>
            </div>
            <footer class="card-footer">
                <div class="row">
                    <div class="col-md-12 text-right">
                        <form action="{{url('admin/customers/delete')}}" method="post">
