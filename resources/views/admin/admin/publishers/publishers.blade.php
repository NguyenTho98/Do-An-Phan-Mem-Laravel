                ...
                <tbody>
                    @foreach ($publishers as $publisher)
                        <tr class="post{{$publisher->id}}">
                            ...
                            <td class="actions">
                                <a href="{{ url('admin/publishers/detail')."/".$publisher->id }}" class="edit-row"><i class="fas fa-eye"></i></a>
            ...
            <div class="card-body">
                <div class="modal-wrapper">
                    ...
                    <div class="modal-text">
                        <p class="mb-0">Các đơn nhập hàng và toàn bộ các key game sẽ bị xóa. Bạn có muốn tiếp tục?</p>
                    </div>
                </div>
            </div>
            <footer class="card-footer">
                <div class="row">
                    <div class="col-md-12 text-right">
                        <form action="{{url('admin/publishers/delete')}}" method="post" id="form_delete">
                            {{ csrf_field() }}
