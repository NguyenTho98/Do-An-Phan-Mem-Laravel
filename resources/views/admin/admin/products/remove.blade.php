            ...
            <table class="table table-bordered table-striped mb-0" id="datatable-default">
                ...
                <tbody>
                    @foreach ($products as $product)
                        <tr>
                            <td>{{ $product->id }}</td>
                            <td> <img src="{{ asset($product->picture) }}" alt="" width="100" height="100"></td>
                            <td>{{ $product->name }}</td>
            ...
            <div class="card-body">
                <div class="modal-wrapper">
                    ...
                    <div class="modal-text">
                        <p class="mb-0">Hoàn tác thông tin sản phẩm. Bạn có muốn tiếp tục?</p>
                    </div>
                </div>
            </div>
            <footer class="card-footer">
                <div class="row">
                    <div class="col-md-12 text-right">
                        <form action="{{url('admin/products/undodelete')}}" method="post" id="form_delete">
                            {{ csrf_field() }}
